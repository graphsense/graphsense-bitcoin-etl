...
from scripts.btc_cassandra_streaming import is_coinjoin
...
def test_c1():
    tx = json.loads(open('scripts/test/txs/ab188e2ae90a6e54dad6200f0d2ef188b723d2b393bbd01e65d753058afcba62.json').read())

    converted = mapper.transaction_to_dict(mapper.json_dict_to_transaction(tx, block, 0))
...
def test_c2():
    tx = json.loads(open('scripts/test/txs/59d2780701c8352ad77c026652d67ea596fe4e9316580f02c171e2137fa91578.json').read())
